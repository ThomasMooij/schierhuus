...
export default function AreaText() {
  return (
    <section className="relative flex flex-col justify-center items-center max-h-[45vh] shadow-full rounded-2xl p-10 border-none	">
    <div className="z-10 p-5 flex flex-col items-center justify-center">
      <article className='flex flex-col items-center justify-center'>
        <MotionHeader1 variants={itemVariants} className="text-white text-4xl font-bold mb-4" title="Te doen in de omgeving" />
